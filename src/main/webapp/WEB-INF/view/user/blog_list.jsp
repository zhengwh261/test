					...
					<c:forEach items="${page.list}" var="blog">
						<tr>
							...
							<td><a class="	glyphicon glyphicon-remove"
								href="${pageContext.request.contextPath }/delete?id=${blog.id }" class="btn btn-danger" role="button">删除</a>
							<a class="	glyphicon glyphicon-edit"
								   href="${pageContext.request.contextPath }/toupdate?id=${blog.id }" class="btn btn-danger" role="button">编辑</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
